...
def setup_all():
    ...
    alias_cmd_bash = f"alias tema='python3 {os.path.expanduser('~')}/termux_tema/temaV2.py'\n"
    alias_cmd_fish = f"alias tema 'python3 {os.path.expanduser('~')}/termux_tema/temaV2.py'\n"
