...
def preview_theme(num):
    ...
    print(f" \033[38;2;{r1};{g1};{b1}m██\033[0m \033[38;2;{r2};{g2};{b2}m██\033[0m \033[38;2;{r3};{g3};{b3}m██\033[0m \033[38;2;{r4};{g4};{b4}m██\033[0m \033[38;2;{r5};{g5};{b5}m██\033[0m \033[38;2;{r6};{g6};{b6}m██\033[0m")
    print(f" \033[48;2;{rb};{gb};{bb}m BG \033[0m \033[38;2;{rf};{gf};{bf}mFG\033[0m\n{'='*40}")
...
def download_font(font_name):
    ...
    if os.path.exists(cache_file):
        run(f"cp {cache_file} {FONT_PATH}"); return
    print(f"Download font {font_name}...")
    os.makedirs(FONT_CACHE, exist_ok=True); os.makedirs(TMP_DIR, exist_ok=True)
    url = FONTS[font_name]; zip_file = f"{TMP_DIR}/{font_name}.zip"
...
def main():
    ...
    while True:
        ...
        if pilih_input.isdigit() and int(pilih_input) in THEMES:
            ...
            if y == 'y':
                apply_theme(pilih)
                break
        else: print("Nomor salah. Pilih 1-15")
